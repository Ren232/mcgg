...
if (isset($_POST['copy']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <form action="" method="post">
            ...
            <p class="break-word">Từ: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?><br>
                <label for="inp_copy_to">Đến:</label>
                <?php echo FM_ROOT_PATH ?>/<input type="text" name="copy_to" id="inp_copy_to" value="<?php echo fm_enc(FM_PATH) ?>">
            </p>
            <p><label><input type="checkbox" name="move" value="1"> Chuyển?</label></p>
            <p>
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    <div class="path">
        <p><b>Copying...</b></p>
        <p class="break-word">
            Từ: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . $copy)) ?><br>
            Đến: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?>
        </p>
        <p>
            <b><a href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1"><i class="fa fa-check-circle"></i> Copy</a></b> &nbsp;
            <b><a href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1&amp;move=1"><i class="fa fa-check-circle"></i> Chuyển</a></b> &nbsp;
            <b><a href="?p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-times-circle"></i> Cancel</a></b>
        </p>
        <p><i>Chọn Folder</i></p>
...
<div class="file-tree-view" id="file-tree-view">
    <div class="tree-title">Cây thư mục</div>
<?php
//file tre view
...
<?php if (!FM_READONLY): ?><th style="width:3%"><label><input type="checkbox" title="Đảo lựa chọn" onclick="checkbox_toggle()"></label></th><?php endif; ?>
<th>Tên</th><th style="width:10%">Kích cỡ</th>
<th style="width:12%">Lần cuối</th>
<?php if (!FM_IS_WIN): ?><th style="width:6%">Perms</th><th style="width:10%">Chủ</th><?php endif; ?>
...
<a href="#/invert-all" class="group-btn" onclick="invert_all();return false;"><i class="fa fa-th-list"></i> Đảo lựa chọn</a> &nbsp;
<input type="submit" class="hidden" name="delete" id="a-delete" value="Delete" onclick="return confirm('Bạn có chắc muốn xóa?')">
...
<a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="float-right" style="color:silver">Bản quyền - prasathmani</a></p>
<?php endif; ?>
</form>
...
<div class="path main-nav">
        ...
        <?php if (!FM_READONLY): ?>
				<span>Đăng nhập với <b><?=$_SESSION['user']?></b> | <a href='.'>Trang chủ</a> | <a href='./console.php'>Console</a> | <a href='./?logout'>Đăng xuất</a></span> | 
...
<head>
<meta charset="utf-8">
<title>Files | MCHostPanel</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="Description" CONTENT="Author: CCP Programmers, H3K Tiny PHP File Manager - Re-edit bởi GGJohny">
